...
GRAPH lectureFichier(const char *filename, int* S, int* nba){
/* Ouverture d'un fichier .txt, lecture de son contenu et enregistrement dans un graphe. Retourne ce graphe.
* 
*GRAPH est un tableau de T_SOMMET,et, pour être retourné par la fonction (conservé après son execution ce tableau doit être alloué dynamiquement
*
*S est le nombre de sommets du graphe (passage par adresse)
*/
